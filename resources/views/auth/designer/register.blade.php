...
<head>
    ...
    <title>Designer Registration - DesignSphere</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    <a href="{{ url('/buyer/register') }}" class="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 text-sm font-medium rounded-lg transition-colors">
                        Buyer Registration
                    </a>
                </div>
            </div>
            ...
            <div class="flex justify-center">
                <div class="w-full max-w-md">
                    ...
                    <div class="text-center mb-8">
                        ...
                        <h2 class="text-3xl font-bold text-gray-900 mb-2">Join as Designer</h2>
                        <p class="text-gray-600">Create your designer account and start showcasing your work</p>
                    </div>

                    <!-- Form -->
                    <div class="bg-white shadow-2xl rounded-2xl p-8 border border-gray-100">
                        <form method="POST" action="{{ route('designer.register') }}" class="space-y-6">
                            @csrf
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input id="name" type="text" 
                                           class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-xl leading-5 bg-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors @error('name') border-red-500 ring-2 ring-red-500 @enderror" 
                                           name="name" 
                                           value="{{ old('name') }}" 
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input id="password_confirmation" type="password" 
                                           class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-xl leading-5 bg-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" 
