...
<head>
    ...
    <title>Buyer Login - DesignSphere</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    <a href="{{ url('/designer/login') }}" class="text-blue-600 hover:text-blue-700 px-4 py-2 text-sm font-medium border border-blue-200 rounded-lg hover:bg-blue-50 transition-all">
                        Designer Login
                    </a>
                </div>
            </div>
            ...
            <div class="flex justify-center">
                <div class="w-full max-w-md">
                    ...
                    <div class="text-center mb-8">
                        ...
                        <h2 class="text-3xl font-bold text-gray-900 mb-2">Welcome Back, Buyer</h2>
                        <p class="text-gray-600">Sign in to discover amazing fashion designs</p>
                    </div>
